  ...
  public void updateMessages(Object roundId, List<ChatMessage> newMessages) {
    ...
    if (existingMessages.isEmpty()) {
      ...
      String template = """
          ...
          - 사용자가 단답으로 답변할 경우, 더 자세한 이야기를 할 수 있도록 유도해주세요.
          - 후속 질문은 **최대 10회**까지만 허용하고, 이후 요약 및 종료 멘트로 마무리합니다.
          - 사용자가 부정적인 경험을 이야기하면으로 인해 지금 생긴 긍정적 의미를 생각해볼 수 있도록 유도합니다.
          - 기억을 더욱 정교화해서 구체적으로 이야기 할 수 있도록 유도합니다.
                            
          출력 규칙(중요):
          - 질문은 **"[Q1] ", "[Q2] ", …, "[Q10] "**으로 시작하며, 한 메시지에 질문은 하나만 포함합니다.
          - "[Q1] ", "[Q2] ", …, "[Q10] " 앞에는 꼭 줄바꿈을 해줍니다.
